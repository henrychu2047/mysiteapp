...
export default function Page() {
  ...
  return <>
    ...
    <main className="app-shell">
      ...
      {appMode === 'handover' && <section className="content info-page"><div className="section-heading"><div><p className="eyebrow">HANDOVER</p><h2>制房移交</h2></div></div><div className="info-empty"><span>▤</span><strong>功能開發中</strong><small>制房移交模組即將推出</small></div></section>}
