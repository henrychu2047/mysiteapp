...
const tagOptions: Record<string, string[]> = {
  ...
  事項: ['未做喉', '未做糟', '未補明喉', '未穿線', '未裝燈', '未裝膠器', '進度慢', '被破壞', '受其它行頭阻礙', '受建築阻礙', '其它行頭無跟CSD做'],
  安全: ['無圍欄', '不正規高空工作', '無安全帶', '無帶安全帽', '無安全繩'],
  其它: ['已收待驗', '已入貨倉', '已交判頭', '來貨有問題', '來貨破爛'],
}
