...
export function ContinuousCameraModal({ categories, initialCategory, tags, visibleTags, note, noteHistory, selectedNotes, onCapture, onClose, autoStart = false, onCategorySelected, onSelectCategory, onSelectTag, onNoteChange, onRememberNote, onToggleRecentNote }: Props) {
